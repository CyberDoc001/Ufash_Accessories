...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-tsr2@gtoz9bh2%u$a@hy7asc!(79(kos$yj0%nk!3*x)s_9j%v')
...
# PostgreSQL configuration - PRODUCTION USE ONLY

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.getenv('DB_NAME', 'ufash_db'),
...
# Session timeout settings - Auto logout after 15 minutes of inactivity
